...
class PermissionSeeder extends Seeder
{
    ...
    private const ROLE_PERMISSIONS = [
        ...
        'administrador_agencia' => ['agencias.ver', 'usuarios.ver', 'usuarios.crear', 'usuarios.editar', 'clientes.ver', 'clientes.crear', 'clientes.editar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'cajas.cerrar_forzado', 'bovedas.ver', 'bovedas.cerrar', 'billetajes.ver', 'billetajes.crear', 'billetajes.aprobar', 'billetajes.rechazar', 'bienes.ver', 'bienes.crear', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.aprobar', 'creditos_prendarios.rechazar', 'creditos_prendarios.firmar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar', 'configuraciones_credito_prendario.ver', 'configuraciones_credito_prendario.editar'],
        'peinadora' => ['clientes.ver', 'clientes.crear', 'clientes.editar'],
        'supervisor' => ['clientes.ver', 'clientes.asignar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'billetajes.ver', 'billetajes.crear', 'bienes.ver', 'bienes.crear', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.firmar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar'],
        'asesor' => ['clientes.ver', 'clientes.crear', 'clientes.editar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'billetajes.ver', 'billetajes.crear', 'bienes.ver', 'bienes.crear', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.firmar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar'],
    ];
