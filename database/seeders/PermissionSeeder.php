...
class PermissionSeeder extends Seeder
{
    ...
    private const ROLE_PERMISSIONS = [
        'administrador_general' => ['empresas.ver', 'agencias.ver', 'agencias.crear', 'agencias.editar', 'agencias.eliminar', 'usuarios.ver', 'usuarios.crear', 'usuarios.editar', 'usuarios.eliminar', 'clientes.ver', 'clientes.crear', 'clientes.editar', 'clientes.eliminar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'cajas.cerrar_forzado', 'cajas.reabrir', 'bovedas.ver', 'bovedas.cerrar', 'bovedas.aperturar', 'bovedas.inyectar', 'bovedas.reabrir', 'billetajes.ver', 'billetajes.crear', 'billetajes.aprobar', 'billetajes.rechazar', 'bienes.ver', 'bienes.crear', 'bienes.editar', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.subsanar', 'creditos_prendarios.aprobar', 'creditos_prendarios.rechazar', 'creditos_prendarios.desembolsar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar', 'creditos_prendarios.editar', 'creditos_prendarios.revertir_aprobacion', 'creditos_prendarios.enviar_tienda', 'configuraciones_credito_prendario.ver', 'configuraciones_credito_prendario.editar'],
        ...
        'administrador_agencia' => ['agencias.ver', 'usuarios.ver', 'usuarios.crear', 'usuarios.editar', 'clientes.ver', 'clientes.crear', 'clientes.editar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'cajas.cerrar_forzado', 'cajas.reabrir', 'bovedas.ver', 'bovedas.cerrar', 'bovedas.reabrir', 'billetajes.ver', 'billetajes.crear', 'billetajes.aprobar', 'billetajes.rechazar', 'bienes.ver', 'bienes.crear', 'bienes.editar', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.subsanar', 'creditos_prendarios.aprobar', 'creditos_prendarios.rechazar', 'creditos_prendarios.desembolsar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar', 'creditos_prendarios.editar', 'creditos_prendarios.revertir_aprobacion', 'creditos_prendarios.enviar_tienda', 'configuraciones_credito_prendario.ver', 'configuraciones_credito_prendario.editar'],
        'peinadora' => ['clientes.ver', 'clientes.crear', 'clientes.editar'],
        'supervisor' => ['clientes.ver', 'clientes.asignar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'billetajes.ver', 'billetajes.crear', 'bienes.ver', 'bienes.crear', 'bienes.editar', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.subsanar', 'creditos_prendarios.desembolsar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar'],
        'asesor' => ['clientes.ver', 'clientes.crear', 'clientes.editar', 'cajas.ver', 'cajas.aperturar', 'cajas.cerrar', 'billetajes.ver', 'billetajes.crear', 'bienes.ver', 'bienes.crear', 'bienes.editar', 'creditos_prendarios.ver', 'creditos_prendarios.crear', 'creditos_prendarios.subsanar', 'creditos_prendarios.desembolsar', 'creditos_prendarios.refrendar', 'creditos_prendarios.liquidar'],
    ];
