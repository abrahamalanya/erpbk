...
it('broadcasts to the asesor and the controlling administrador_agencia when a crédito is solicitado', function () {
    ...
    Event::assertDispatched(CreditoPrendarioActualizado::class, function (CreditoPrendarioActualizado $event): bool {
...
it('broadcasts the new chained crédito to the asesor and controlling administrador_agencia on refrendo', function () {
    ...
    Event::assertDispatched(CreditoPrendarioActualizado::class, fn (CreditoPrendarioActualizado $event): bool => $event->credito->id === $nuevoId
